          ...
          <div className="lg:col-span-8 flex flex-col gap-10">
            ...
            {project.codeRunnerEnabled && project.codeHtml && (
              ...
              >
                ...
                >
                  {/* Served from its own URL (not srcDoc): srcdoc iframes
                      inherit the site's strict nonce CSP, which blocks the
                      demos' CDN scripts and inline code. The backend demo
                      endpoint responds with its own relaxed CSP; sandbox
                      stays the security boundary. demoKey in the query
                      forces a genuine reload on Reset. */}
                  <iframe
                    key={demoKey}
                    src={`${import.meta.env.VITE_API_URL || '/api'}/projects/demo/${project.slug}?r=${demoKey}`}
